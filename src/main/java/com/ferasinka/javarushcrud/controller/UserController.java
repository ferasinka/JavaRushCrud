package com.ferasinka.javarushcrud.controller;

import com.ferasinka.javarushcrud.model.SearchString;
import com.ferasinka.javarushcrud.model.User;
import com.ferasinka.javarushcrud.service.UserService;
...
public class UserController {
	...
	public String listUsers(@PathVariable("index") int index, Model model) {
		if (pagesUsers == null) {
			pagesUsers = userService.listUsers();
		}
	...
	public String searchString(@ModelAttribute("searchString") SearchString name, Model model) {
		model.addAttribute("foundUsers", userService.getUserByName(name.getSearchName()));
